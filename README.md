...
一个 Windows 下的《反恐精英 2》(CS2) 备份小工具（**白色主题**）：自动识别 Steam 账户
（圆形头像 + 昵称 + 账户 ID），按用户备份 **730 全部数据** 或 **游戏 CFG 配置** 为 zip 包，
支持跨用户恢复（恢复前自动备份目标现有配置并标明来源），右侧内置 **AI 逐行注释 cfg** 面板。
打包为单 exe，免安装。

> 🌐 官网：https://chenyanglt.github.io/CS2BackupTool ｜ ⬇ 下载：https://github.com/ChenyangLT/CS2BackupTool/releases/latest ｜ 👤 作者 B 站：https://space.bilibili.com/3461567773411503
...
👤 **作者：Chen_yang_ ｜ Deepseek V4 Pro Vibe Coding**

- 软件内「ℹ️ 关于」界面会自动获取作者 B 站头像与粉丝数，并可一键直达 B 站主页。
- B 站主页：<https://space.bilibili.com/3461567773411503>
